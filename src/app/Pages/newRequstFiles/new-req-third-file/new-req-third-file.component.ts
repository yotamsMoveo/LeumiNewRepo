...
@Component({
  selector: 'app-new-req-third-file',
  templateUrl: './new-req-third-file.component.html',
  styleUrls: ['./new-req-third-file.component.css'],
})
export class NewReqThirdFileComponent implements OnInit {
  public workTime: number = 1;
  public isWorkStatusDic: string = '';
  public nextPage: boolean = false;
  public workStatusDic = 'workStatusDic';
